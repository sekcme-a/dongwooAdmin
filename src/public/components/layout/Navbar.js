...
const Navbar = () => {
  ...
  const handleItemClick = (id) => {
    if (openedItem === id) setOpenedItem(-1);
        ...
        >
          ...
          <Collapse in={openedItem === 0} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItemButton
                sx={{ pl: 4 }}
                onClick={() => onClick("team/teamProfile")}
              >
                <ListItemIcon>
            ...
            <List component="div" disablePadding>
              <ListItemButton
                sx={{ pl: 4 }}
                onClick={() => onClick("team/manageTeam")}
              >
                <ListItemIcon>
                  <Diversity3Icon />
                </ListItemIcon>
            ...
            {team.teamId === "dongwoomain" && (
              <>
                <List component="div" disablePadding>
                  <ListItemButton
                    sx={{ pl: 4 }}
                    onClick={() => onClick("post/announcement")}
                  >
                    <ListItemIcon>
            ...
            {team.teamId === "samsung" && (
              <>
                ...
                <List component="div" disablePadding>
                  <ListItemButton
                    sx={{ pl: 4 }}
                    onClick={() => onClick("post/construction")}
                  >
                    <ListItemIcon>
                      <NewspaperIcon />
                    </ListItemIcon>
              ...
              <>
                ...
                <List component="div" disablePadding>
                  ...
                  >
                    ...
                    <ListItemText primary="동우뉴스" />
                  </ListItemButton>
                </List>
                <List component="div" disablePadding>
                  <ListItemButton
                    sx={{ pl: 4 }}
                    onClick={() => onClick("post/achievements")}
                  >
                    <ListItemIcon>
                      <NewspaperIcon />
                    </ListItemIcon>
                    <ListItemText primary="사업실적" />
                  </ListItemButton>
                </List>
                <List component="div" disablePadding>
                  <ListItemButton
                    sx={{ pl: 4 }}
                    onClick={() => onClick("post/advertisement")}
                  >
                    <ListItemIcon>
                      <CampaignOutlinedIcon />
                    </ListItemIcon>
          ...
          <ListItemButton
            onClick={() => router.push(`/${team.teamId}/post/popup`)}
          >
            <ListItemIcon>
              <WysiwygIcon />
            </ListItemIcon>
